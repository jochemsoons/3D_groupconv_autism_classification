...
def plot_accuracy(args, num_epochs, train_acc_list, val_acc_list,
                    PLOT_STORE_PATH):
...
def plot_loss(args, num_epochs, train_loss_list, val_loss_list, val_acc_list,
                PLOT_STORE_PATH):
    ...
    ax.legend(loc='best')
    fig.savefig(PLOT_STORE_PATH + 'loss_{}_{}_{:.2f}_{:.5f}.png'.format(args.model, args.summary,max(val_acc_list), args.lr))
