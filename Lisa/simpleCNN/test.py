...
OPTIM_STORE_PATH = args.optim_store_path
...
print("Testing on {} train images".format(len(test_loader.dataset)))
...
ax3.set_ylim([0,1])
ax3.legend(loc="best")
fig3.savefig('roc_auc_curve_{}_{}_{:.2f}_{:.5f}.png'.format(args.model, args.summary, test_acc, args.lr))
