...
W_conv1 = weight_variable([3,3, 3, 1, 32])  # shape of weight tensor = [5,5,1,32]
...
print(x_image.get_shape, 'size x_image') # (?, 256, 256, 40, 1)  # -> output image: 28x28 x1
...
W_conv2 = weight_variable([3, 3, 3, 32, 64]) # [5, 5, 32, 64]
